...
from og_client import rest
from og_client.configuration import Configuration
from og_client.exceptions import ApiTypeError, ApiValueError, ApiException
from og_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = GlobalApi()
        api_instance.global_config_create  # this is an instance of the class Endpoint
        api_instance.global_config_create()  # this invokes api_instance.global_config_create.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.global_config_create.callable or self.callable in this class
